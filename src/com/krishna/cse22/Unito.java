...
public class Unito extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if(position == 0){
			...
			try{
				...
				Toast.makeText(Unito.this,"no pdf found",Toast.LENGTH_LONG).show();
			}
			...
			if (pdf.exists()){
				...
				try{
					...
					Toast.makeText(Unito.this,"no application to view the pdf",Toast.LENGTH_LONG).show();
				}
			}
			else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.unito, menu);
		return true;
	}
}